        ...
        <div class="card card-primary card-outline">          
            <div class="card-header">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <a href="{{url('admin/section/create')}}" class="btn btn-success">add <i class="fa fa-plus"></i></a>
                </div>
              </div>
            </div>
            <div class="card-body">
                  ...
                  <tbody>
                    @foreach($data as $kay => $item)
                        ...
                        <tr>
                          ...
                          <td>{{$item->about}}</td>
                          <td>
                            <a  class="btn btn-primary btn-sm" href="{{url('admin/section/'. $item->id .'/edit')}}">edit <i class="fa fa-edit"></i></a>
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer justify-content-between">
                                    <form method="post" action="{{url("admin/section/".$item->id)}}">
                                      @csrf
                                      @method('delete')
