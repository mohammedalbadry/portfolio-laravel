        ...
        <div class="card card-primary card-outline">          
            <div class="card-header">
              ...
              <div class="row">
                ...
                <div class="col-md-7">
                  <a href="{{url('admin/email/create')}}" class="btn btn-success">new email <i class="fa fa-plus"></i></a>
                  <a href="{{url('admin/access')}}" class="btn btn-primary">access your account <i class="fas fa-envelope-open"></i></i></a>
                </div>
                  ...
                  <tbody>
                    @foreach($data as $kay => $item)
                        ...
                        <tr>
                          ...
                          <td>
                            @if($item->status == 1)
                              <button class="btn btn-success btn-sm">saved and sent</button>
                            @else
                              <button class="btn btn-warning btn-sm">only saved</button>
                            @endif
                          </td>       
                          <td>
                            <a  class="btn btn-primary btn-sm" href="{{url('admin/email/'. $item->id .'/edit')}}">edit <i class="fas fa-edit"></i></a>
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer justify-content-between">
                                    <form method="post" action="{{url("admin/email/".$item->id)}}">
                                      @csrf
                                      @method('delete')
