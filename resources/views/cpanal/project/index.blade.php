        ...
        <div class="card card-primary card-outline">          
            <div class="card-header">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <a href="{{url('admin/project/create')}}" class="btn btn-success">add <i class="fa fa-plus"></i></a>
                </div>
              </div>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered">
                  <thead>                  
                    <tr>
                      ...
                      <th>title</th>
                      <th>img</th>
                      <th class="d-none d-sm-block">job title</th>
                      <th>actions</th>
                    </tr>
                  </thead>
                  <tbody>
                    @foreach($data as $kay => $item)
                        ...
                        <tr>
                          <td>{{$kay + 1}}</td>
                          <td>{{$item->title}}</td>
                          <td><img style="width:30px; height:30px" src="{{$item->img_path}}" alt="{{$item->title}}"></td>
                          <td class="d-none d-sm-block">{{$item->job_title}}</</td>
                          <td>
                            <a  class="btn btn-primary btn-sm" href="{{url('admin/project/'. $item->id .'/edit')}}">edit <i class="fa fa-edit"></i></a>
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer justify-content-between">
                                    <form method="post" action="{{url("admin/project/".$item->id)}}">
                                      @csrf
                                      @method('delete')
