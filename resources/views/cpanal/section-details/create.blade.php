    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                ...
                <form role="form" method="post" action="{{url('admin/section-details')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input name="prop_name" value="{{old('prop_name')}}" type="text" class="form-control" placeholder="property  name">
                    </div>

                    <div class="form-group">
                        <label for="prop_value">property value</label>
                        <input name="prop_value" value="{{old('prop_value')}}" type="text" class="form-control" placeholder="property  value">
                    </div>
                    ...
                    <div class="options">
                        ...
                        <div class="options-body">        
                          ...
                          <div class="row one_option">      
                            ...
                            <div class="col-11 col-md-5">
                              <div class="form-group">
                                <input name="option_name[]" value="" type="text" class="form-control" placeholder="property  value">
                              </div>
                            </div>                         

                            <div class="col-11 col-md-6">
                              <div class="form-group">
                                <input name="option_value[]" value="" type="text" class="form-control" placeholder="property  value">
                              </div>
                            </div>
                          </div>
